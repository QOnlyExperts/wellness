...
export interface IRequestRepository {
  ...
  findPendingRequest(infoPersonId: number): Promise<RequestEntity | null>;
  ...
  updateStatus(id: number, update: Partial<RequestEntity>, t: Transaction): Promise<RequestEntity>; // Actualiza el estado de una solicitud

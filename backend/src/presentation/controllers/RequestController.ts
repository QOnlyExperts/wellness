...
export class RequestController {
  ...
  constructor() {
    ...
    this.getRequestByIdInfoPersonUseCase = resolveGetRequestByIdInfoPersonUseCase();
    this.getRequestByStatusByIdInfoPersonUseCase = resolveGetRequestByStatusByIdInfoPersonUseCase();
  ...
  public async update(req: Request, res: Response, next: NextFunction): Promise<Response | void> {
    try {
      ...
      const implementsList = await this.requestUpdateUseCase.execute(id, updates);
